...
class WorkerWindow(other_interfaces.InventoryWindow):
    ...
    def __init__(
        ...
        *sprite_group: "sprite_groups.CameraAwareLayeredUpdates"
        ...
        self._worker = worker
        self._worker_information_pane = None
