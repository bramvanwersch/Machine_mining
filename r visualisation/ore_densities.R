...
#iron gold zinc copper coal, titanium
...
#FILLER
colors = c(rgb(137, 79, 33 ,200, maxColorValue = 255), rgb(155, 155, 155, 200, maxColorValue = 255),
           rgb(105, 89, 76, 200, maxColorValue = 255), rgb(199, 127, 195, 200, maxColorValue = 255))
#dirt, stone, granite, final_stone
mean=c(0, 30, 70, 100)
sd=c(10,10,8,2)
x <- seq(0, 100,length=100)
lower.x <- 0
...
hx <- dnorm(x,mean[1],sd[1])
plot(x, hx, type ='l', xlab="Filler depth", ylab="probability",
     main="Filler distributions", col = colors[1], ylim = c(0,0.2))
